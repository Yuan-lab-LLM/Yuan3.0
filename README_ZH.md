...
* **[2025-12-30]** **发布源3.0-40B大模型，面向企业级引用场景的高性能模型：Yuan3.0 Flash**
...
浪潮信息 **“源3.0”大模型（Yuan 3.0）** 是面向真实应用场景设计的新一代通用大模型，重点覆盖 **文本检索、多模态表格分析、复杂表格理解与摘要生成** 等高价值任务，适用于知识密集型与结构化数据占比高的应用环境。
...
在多项主流评测中，源3.0 在代码生成、数学推理、科学问答与综合知识理解等任务上展现出有竞争力的性能表现，特别在文本检索、多模态表格分析、复杂表格理解与摘要生成等企业级关键能力上已全面超越OpenAI GPT-5.1，成为企业智能化转型的理想选择。
